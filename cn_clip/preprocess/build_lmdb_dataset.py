...
if __name__ == "__main__":
    ...
    for split in specified_splits:
        ...
        pairs_annotation_path = '/mnt/petrelfs/lijiaxing1/lijiaxing/Chinese-CLIP/data/datasets/Multimodal_Retrieval/MR_train_queries.jsonl'
        with open(pairs_annotation_path, "r", encoding="utf-8") as fin_pairs:
            ...
            for line in tqdm(fin_pairs):
                ...
                for item_id in obj["item_ids"]:
                    dump = pickle.dumps((item_id, obj['query_id'], obj['query_text'])) # encoded (image_id, text_id, text)
