...
# data options
train_data=/mnt/petrelfs/lijiaxing1/lijiaxing/Chinese-CLIP/data/datasets/Multimodal_Retrieval/lmdb/train_pro
...
name=li_finetune_5.29_dp_vit-h-14_roberta-base_bs128_8gpu
