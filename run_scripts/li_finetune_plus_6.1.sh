...
export MASTER_PORT=8591
# The rank of [动画表情]this worker, should be in {0, ..., WORKER_CNT-1}, for single-worker training, please set to 0
export RANK=0 
...
# restore options
resume=/mnt/petrelfs/lijiaxing1/lijiaxing/Chinese-CLIP/data/experiments/li_finetune_6.1_2_vit-h-14_roberta-base_bs128_4gpu/checkpoints/epoch1.pt # or specify your customed ckpt path to resume
...
name=li_finetune_6.1_2_vit-h-14_roberta-base_bs128_4gpu
