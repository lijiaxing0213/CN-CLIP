...
# restore options
resume=/mnt/petrelfs/lijiaxing1/lijiaxing/Chinese-CLIP/data/experiments/li_finetune_6.1_vit-h-14_roberta-base_bs128_4gpu/checkpoints/epoch1.pt # or specify your customed ckpt path to resume
...
name=li_finetune_6.1_vit-h-14_roberta-base_bs128_4gpu
